  ...
  <section id="sobre" className="py-32 lg:py-44 bg-cream">
    <div className="max-w-7xl mx-auto px-6 lg:px-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        {/* Image */}
        <motion.div
          className="relative overflow-hidden aspect-[3/4] lg:aspect-auto lg:h-[700px]"
        ...
        >
          <p className="font-sans text-[10px] tracking-[0.4em] uppercase text-primary mb-8 font-medium">
            Nossa História
          </p>
          <h2 className="font-display text-2xl md:text-3xl lg:text-4xl font-normal text-foreground leading-[1.2] mb-10 tracking-[0.04em] uppercase">
          ...
          <a
            href="#"
            className="inline-block text-[10px] font-sans font-medium tracking-[0.25em] uppercase text-primary hover:text-gold-light transition-colors border-b border-primary/30 hover:border-primary pb-1"
          >
