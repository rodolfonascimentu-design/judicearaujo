...
const footerLinks = ["Imóveis", "Comprar", "Alugar", "Sobre", "Blog", "Contato"];
  ...
  <footer className="bg-white text-foreground">
    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-16">
        {/* Co-branding logo - left aligned like header */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 lg:gap-16">
          <div>
            <h4 className="font-sans text-[10px] font-medium tracking-[0.3em] uppercase text-foreground/40 mb-8">
              Navegação
            </h4>
          ...
          <div>
            ...
            <div className="flex gap-5">
              <a href="#" className="text-foreground/30 hover:text-primary hover:-translate-y-0.5 transition-all duration-300" aria-label="Instagram">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="#" className="text-foreground/30 hover:text-primary hover:-translate-y-0.5 transition-all duration-300" aria-label="WhatsApp">
                <Phone className="w-4 h-4" />
              </a>
              <a href="#" className="text-foreground/30 hover:text-primary hover:-translate-y-0.5 transition-all duration-300" aria-label="LinkedIn">
    ...
    <div className="border-t border-border/30">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="font-sans text-[10px] text-foreground/25 tracking-wide font-light">
          © 2026 Judice & Araujo. Todos os direitos reservados.
        </p>
        <div className="flex gap-8">
          <a href="#" className="font-sans text-[10px] text-foreground/25 hover:text-primary/60 transition-colors duration-300 tracking-wide font-light">
