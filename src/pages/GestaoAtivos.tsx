...
<p
  className="font-sans text-[10px] tracking-[0.35em] uppercase mb-6 font-medium text-primary-foreground"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="py-28 lg:py-40 px-6 lg:px-12 xl:pl-[max(2rem,calc((100vw-1280px)/2+2rem))]">
              <motion.div {...fadeUp} className="max-w-xl text-secondary">
                ...
                <p
                  className="font-sans text-[15px] font-light leading-[2.1] tracking-wide mb-6 text-secondary"
                ...
                <p
                  className="font-sans text-[15px] font-light leading-[2.1] tracking-wide mb-12 text-secondary"
                  style={{ color: "rgba(255,255,255,0.6)" }}>
